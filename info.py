...
with open(info_file, 'rb') as read_file:
    ...
    best_lambda_1_zero = [float(0)] * 10
    best_models_lambda_1_zero = ['None'] * 10
    ...
    best_lambda_vary = [float(0)] * 10
    best_models_lambda_vary = ['None'] * 10
